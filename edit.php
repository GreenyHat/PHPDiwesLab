...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["name"]) || empty($_POST["phone_number"])) {
    $error = "Please fill all the fields."; //poner en rojo
    ...
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <?php endif ?>
          <!-- ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||| -->
          <form method="POST" action="edit.php?id=<?= $contact["id"] ?>"> <!-- aqui no se puede usar un metodo distinto a post, para ello habria que usar JS -->
            <div class="mb-3 row">
