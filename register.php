    ...
    if ($statement->rowCount() > 0) {
      ...
      $conn
        ...
        ->execute([
          ":name" => $_POST["name"],
          ":email" => $_POST["email"],
          ":password" => password_hash($_POST["password"], PASSWORD_BCRYPT), //haseheo de password para que no te de solo texto plano
        ]);
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form method="POST" action="register.php">
            ...
            <div class="mb-3 row">
              <label for="pasword" class="col-md-4 col-form-label text-md-end">Password</label>
