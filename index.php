<?php
$contacts = [
  ["name" => "Pepe", "phone_number" => "29129873"],
  ["name" => "Jose", "phone_number" => "29129873"],
  ["name" => "Ultano", "phone_number" => "29129873"],
  ["name" => "Raul", "phone_number" => "29129873"],
]; //Esta es la sintaxis de un diccionario
?>
